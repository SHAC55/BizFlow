    ...
    <div className="mt-8 w-full max-w-sm">
      ...
      `}>
        ...
        <div className="relative group">
          {/* Glow effect */}
          <div className="absolute -inset-0.5 bg-gradient-to-r from-gray-300 to-gray-300 rounded-xl blur opacity-30 group-hover:opacity-50 transition duration-500"></div>
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-blue-100 shadow-lg">
            <div className="flex items-start gap-3">
              ...
              <div className="relative">
                <div className="w-10 h-10 rounded-lg bg-black  flex items-center justify-center animate-soft-pulse">
                  <svg className="w-5 h-5 text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </div>
                {/* Small decorative dot */}
                <div className="absolute -top-1 -right-1 w-2 h-2 bg-gray-400 rounded-full animate-ping-slow"></div>
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex gap-1">
                  ...
                  <div className="h-0.5 w-2 bg-gray-300 rounded-full"></div>
                  <div className="h-0.5 w-1 bg-gray-400 rounded-full"></div>
                </div>
              </div>
            </div>
          </div>
